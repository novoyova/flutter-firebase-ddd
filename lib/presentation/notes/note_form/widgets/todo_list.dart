...
import 'package:firebase_ddd_course/presentation/notes/note_form/misc/build_context_x.dart';
      ...
      child: Consumer<FormTodos>(
        builder: (context, formTodos, child) {
          return ImplicitlyAnimatedReorderableList<TodoItemPrimitive>(
            // shrinkWrap: if you have long list can cause performance trouble
            // whenever you are having nested listview inside another scrollable
            // we need to have shrinkWrap: true
            shrinkWrap: true,
              ...
              title: TextFormField(
                ...
                validator: (_) {
                  return context
                      ...
                      .value
                      .fold(
                        // Failure stemming from the TodoList length shoud NOT be displayed
                        // by the individual TextFormFields
                        (f) => null,
